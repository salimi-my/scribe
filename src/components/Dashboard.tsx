...
const Dashboard = ({ subscriptionPlan }: DashboardPageProps) => {
  ...
  return (
    <>
      <main className='mx-auto max-w-7xl px-5 md:px-10 min-h-[calc(100vh_-_7rem_-_1px)]'>
        <div className='pt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 dark:border-gray-600 pb-5 sm:flex-row sm:items-center sm:gap-0'>
              ...
              >
                ...
                <div className='px-6 mt-4 grid grid-cols-3 place-items-center py-2 gap-6 text-xs text-zinc-500 dark:text-zinc-300'>
                  ...
                  <Button
                    ...
                    size='sm'
                    className='w-full hover:bg-destructive/70 hover:text-destructive-foreground/70'
                    variant='destructive'
